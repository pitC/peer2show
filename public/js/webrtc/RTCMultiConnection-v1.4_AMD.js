    ...
    function RTCMultiSession(root) {
        ...
        function acceptRequest(userid, extra) {
            if (root.userType && !root.busy) {
                ...
                else _accept(userid, extra);
            }

            if (!root.userType) _accept(userid, extra);
        }
...
//                    username: '41784574'
        ...
        function _openOffererChannel() {
            ...
            var dataChannelName = options.channel || 'RTCDataChannel';
            
            console.log(dataOpt);
            console.log(dataChannelName);
            
            channel = peer.createDataChannel(dataChannelName,dataOpt);
